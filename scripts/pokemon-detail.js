...
function setTypeBackgroundColor(pokemon) {
  ...
  setElementStyles(
    document.querySelectorAll(".atats-wrap p.stats"),
    "color",
    color
  );
  ...
  background-color: rgba(${rgbaColor}, 0.5);} .stats-wrap .progress-bar::webkit-progress-value {background-color: ${color};
  }`;
...
function createAndAppendElemnt(parent, tag, options = {}) {
...
function displayPokemonDetails(pokemon) {
  ...
  types.forEach(({ type }) => {
    createAndAppendElemnt(typeWrapper, "p", {
  ...
  abilities.forEach(({ ability }) => {
    createAndAppendElemnt(abilitiesWrapper, "p", {
  ...
  stats.forEach(({ stat, base_stat }) => {
    ...
    createAndAppendElemnt(statDiv, "p", {
    ...
    createAndAppendElemnt(statDiv, "progress", {
